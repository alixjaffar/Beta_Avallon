// Helper functions for website scraping
// This file is separate to avoid build-time evaluation issues
// Cheerio is dynamically imported to prevent build-time issues
 ...
 */
export async function fetchCSS(cssUrl: string): Promise<string> {
  try {
 ...
 */
export async function renderWithPuppeteer(url: string): Promise<string> {
