...
import { Site, Agent, Domain, EmailAccount, SystemStatus } from "../../../shared/types";
import { 
  Globe, 
  Bot, 
  Mail, 
...
const Dashboard = () => {
  ...
  const loadData = async () => {
    try {
      setDataLoading(true);
      const [sitesRes, agentsRes, domainsRes, emailRes, statusRes] = await Promise.allSettled([
        apiClient.getSites(),
        apiClient.getAgents(),
      ...
      if (emailRes.status === 'fulfilled') {
        setEmailAccounts(emailRes.value.data || []);
      }
                ...
                <CardContent className="p-8">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="text-center">
                      ...
                      <div className="text-4xl font-bold mb-2">{dataLoading ? "..." : sites.length}</div>
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-4xl font-bold mb-2">{dataLoading ? "..." : agents.filter(a => a.status === 'active').length}</div>
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-4xl font-bold mb-2">{dataLoading ? "..." : domains.filter(d => d.status === 'active').length}</div>
