    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      >
        ...
        <div className="max-w-4xl relative z-10">
          ...
          >
            Build stunning websites with AI, create intelligent agents, secure your domain, and manage everything from one powerful dashboard.{" "}
        ...
        >
          <div className="glass rounded-xl overflow-hidden">
            <img
              src={mounted && theme === "dark" ? "/lovable-uploads/bf56a0c6-48e4-49f7-b286-8e3fda9a3385.png" : "/lovable-uploads/c32c6788-5e4a-4fee-afee-604b03113c7f.png"}
              alt="Avallon Dashboard"
